...
//declaring array variable with all of our questions
var myQuestions = ['Do you think I have any pets?', 'Do you think I have any siblings?', 'Am I trilingual?', 'Do I like to scale icy mountains?', 'Do I think cheesecake is the best?'];
//declaring variable to store user guesses with empty array
var userGuess = [];

//for loop - declaring i as variable to track iterations. Declare variable to store user input and prompt my questions array using i variable to iterate each question. Normalize by adding input user guess array variable with i to track iteration and assign to lower case.
for(var i = 0; i < myQuestions.length; i++) {
  var userInput = prompt(myQuestions[i]);
  userGuess[i] = userInput.toLowerCase();
